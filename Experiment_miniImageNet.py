...
# load raw dataset
datasetStr = "miniImageNet"

from MiniImageNetDataset import MiniImageNetDataset
ds = MiniImageNetDataset()
(X_train, y_train) = (ds.image_train, ds.label_train)
(X_valid, y_valid) = (ds.image_valid, ds.label_valid)
(X_test, y_test) = (ds.image_test, ds.label_test)

# create pair generator
pairgen = PairGen2(X_train, y_train, X_valid, y_valid, X_test, y_test)
